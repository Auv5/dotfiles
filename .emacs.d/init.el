...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm-codesearch fzf helm-projectile zenburn-theme smex smartparens rust-mode projectile processing-mode markdown-mode magit cmake-mode auto-complete ag))))
(custom-set-faces
